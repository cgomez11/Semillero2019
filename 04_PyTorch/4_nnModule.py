...
# sum: losses are summed for each minibatch. Default: 'mean'
# and losses are averaged over each loss element in the batch

# Try later with size_average=True, what is the difference?
